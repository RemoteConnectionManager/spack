...
command will ensure all the root specs are concretized consistently with
what is prescribed in the configuration:
...
explained in :ref:`environments_concretization`. The bahavior active
